...
#### [package.json](https://github.com/paislee/my-ng-boilerplate/blob/master/package.json)

Server-side (command-line) dependencies.

#### [bower.json](https://github.com/paislee/my-ng-boilerplate/blob/master/bower.json)

Client-side (browser) dependencies.

#### [gulpfile.js](https://github.com/paislee/my-ng-boilerplate/blob/master/gulpfile.js)
...
#### [/app](https://github.com/paislee/my-ng-boilerplate/blob/master/app)

All first-party application source code lives here, including HTML, scripts, and styles of whatever flavor.

#### [/app/index.html](https://github.com/paislee/my-ng-boilerplate/blob/master/app/index.html)
...
#### [/app/app.js](https://github.com/paislee/my-ng-boilerplate/blob/master/app/app.js)

The app's main angular module is defined here. This file is always loaded first with gulp-angular-filesort.

#### [/app/components](https://github.com/paislee/my-ng-boilerplate/blob/master/app/components)
...
#### [/app/styles](https://github.com/paislee/my-ng-boilerplate/blob/master/app/styles)

Custom app styles (I use SASS) live here. There's also a foundation settings file.

#### [server.js](https://github.com/paislee/my-ng-boilerplate/blob/master/server.js)
...
#### [/devServer](https://github.com/paislee/my-ng-boilerplate/blob/master/devServer)
