...
pipes.processedLocaleDev = function() {
    return gulp.src(paths.locales)
        .pipe(gulp.dest(paths.distDev + '/i18n/'));
};

pipes.processedLocaleProd = function() {
    return gulp.src(paths.locales)
...
gulp.task('watch-dev', ['clean-build-app-dev', 'validate-devserver-scripts'], function() {
    ...
    // watch locales
    gulp.watch(paths.locales, function() {
        return pipes.processedLocaleDev()
            .pipe(plugins.livereload());
    });
